...
public abstract class BeanUtils {
	...
	public static void copyProperties(Object source, Object target, String[] ignoreProperties)
	   ...
	   public static void copyProperties(Object source, Object target, boolean isClear)
       throws BeansException
   {
       copyProperties(source, target, null, null, isClear);
   }
	   
	private static void copyProperties(Object source, Object target, Class editable, String ignoreProperties[], boolean  isClear){
		//add by jsmarttools
		/*
		System.out.println(isClear+"-------------------------");
		StackTraceElement[] d = Thread.currentThread().getStackTrace();
		for (int i = 0; i < d.length; i++) {
			System.out.println(d[i].getClassName());
			System.out.println(d[i].getLineNumber());
		}
		*/
