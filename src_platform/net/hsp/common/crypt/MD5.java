...
public class MD5
{
	 ...
	 */
	private static final String crypt(String password)
	{
	 ...
	 *            Password to be encrypted
	 */
	private static final String crypt(String password, String salt)
	{
	 ...
	 *            user password
	 */
	private static final String crypt(String password, String salt, String magic)
	{
		byte finalState[];
		long l;
		/**
	...
	// 加密
	private static String KL(String inStr,long type)
	{
		String s = new String(MD5.getMD5(String.valueOf(type).getBytes()));
