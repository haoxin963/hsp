...
import net.hsp.common.weixin.bean.pay.PayFeedback;
import net.hsp.common.weixin.bean.pay.PayNativeInput;
import net.hsp.common.weixin.bean.pay.PayNotify;
import net.hsp.common.weixin.bean.pay.PayWarn;
