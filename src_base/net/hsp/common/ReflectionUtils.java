...
public class ReflectionUtils {
	 ...
	 */
	public static Exception convertReflectionExceptionToUnchecked(Exception e) {
	...
	public static Method getAccessibleMethod(final Object obj, final String methodName) {
		...
		for (Class<?> superClass = obj.getClass(); superClass != Object.class; superClass = superClass.getSuperclass()) {
			try {
				...
				Method[] s = superClass.getDeclaredMethods();
				for (int i = 0; i < s.length; i++) {
					if (s[i].getName().equals(methodName)) {
						return s[i];
					}
				} 
	...
	public static Class<?>[] getMethodParameterTypes(final Method m) { 
