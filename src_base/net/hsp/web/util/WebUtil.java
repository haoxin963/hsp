 ...
 * 
 * $Id: WebUtils.java,v 1.1 2010/08/14 04:11:41 Administrator Exp $
 */
...
public class WebUtil {
	...
	public static void forward(HttpServletRequest request, HttpServletResponse res,String path) {
...
//		System.out.println("查看路径:"+realPath+"page"+path);
		...
		String custPath = viewFolderName+"/"+ path.replaceAll(bizFolder+"/",bizFolder+"/"+custId+"/");
