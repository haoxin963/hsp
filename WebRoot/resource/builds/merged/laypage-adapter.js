...
$.fn.bsgrid.setPagingValues = function (options) {
    ...
    if (options.settings.pageSizeSelect) {
        ...
        $('#' + options.pagingId + '>div').prepend('<span>每页显示:</span><select id="' + options.pagingId + '_pageSize' + '" style="height: 26px;width:50px; padding:0 5px; margin-left: -8px; margin-right: 10px;"></select>');
