		...
		<div id="tb" class="searchTb">
			<form id="searchForm" method="post" class="searchForm">
				...
				<input type="text" style="display: none" name="exportTitle"
					id="exportTitle" />
				用户名${separator}
				<input type='text' class='filter' name="filter[userName]">	
				真实姓名${separator}
				<input type='text' class='filter' name="filter[trueName]">
		...
		<table id="dg" width="100%" height="100%">
			<thead>
				<tr id="gridThead">
					...
					<th field="userName" width=80 report=true>
						用户名
					</th>
					<th field="trueName" width=100 report=true>
						真实姓名
					</th>
				</tr>
			</thead>
