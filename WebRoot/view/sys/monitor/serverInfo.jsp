...
A:hover { COLOR: #95B8E7}
body,td,span { font-size: 9pt}
.input  { BACKGROUND-COLOR: #ffffff;BORDER:#95B8E7 1px solid;FONT-SIZE: 9pt}
.backc  { BACKGROUND-COLOR: #95B8E7;BORDER:#95B8E7 1px solid;FONT-SIZE: 9pt;color:white}
.PicBar { background-color: #95B8E7; border: 1px solid #000000; height: 12px;}
...
| <a href="#ISpeedTest">服务器连接速度</a> 
  ...
  <tr> 
    <td height="22" align="center" bgcolor="#95B8E7" onclick="showsubmenu(0)"><font color=#FFFFFF><strong>服务器相关参数</strong></font> 
...
<a href="#top" title="返回顶部"><font face='Webdings' color=#FFFFFF>5</font></a> <span id=txt0 name=txt0><a href='#' title='关闭此项'><font face='Wingdings' color=#FFFFFF>x</font></a></span> 
  ...
  <tr> 
    <td style="display" id='submenu0'><table border=0 width=100% cellspacing=1 cellpadding=3 bgcolor="#95B8E7">
...
<table border="0" cellpadding="0" cellspacing="1" class="tableBorder">
  <tr> 
      <td height="22" align="center" bgcolor="#95B8E7" onclick="showsubmenu(1)"><font color=#FFFFFF><strong>JAVA相关参数</strong></font> 
  ...
  <tr> 
    <td style="display" id='submenu1'>
		<table border=0 width=100% cellspacing=1 cellpadding=3 bgcolor="#95B8E7">
  ...
  <table border="0" cellpadding="0" cellspacing="1" class="tableBorder">
    <tr> 
      <td height="22" align="center" bgcolor="#95B8E7" onclick="showsubmenu(2)"><font color=#FFFFFF><strong>参数查询</strong></font> 
        <a href="#top" title="返回顶部"><font face='Webdings' color=#FFFFFF>5</font></a> 
 ...
 %>
  ...
  <table border="0" cellpadding="0" cellspacing="1" class="tableBorder">
    <tr> 
      <td height="22" align="center" bgcolor="#95B8E7" onclick="showsubmenu(3)"><font color=#FFFFFF><strong>服务器运算能力</strong></font> 
        <a href="#top" title="返回顶部"><font face='Webdings' color=#FFFFFF>5</font></a> 
        <span id=txt3 name=txt3><a href='#' title='关闭此项'><font face='Wingdings' color=#FFFFFF>x</font></a></span> 
      </td>
    </tr>
    <tr> 
      <td style="display" id='submenu3'> <table border=0 width=100% cellspacing=1 cellpadding=3 bgcolor="#95B8E7">
          <tr bgcolor="#fcc79b" height="22"> 
...
<%}%>
  ...
  <table border="0" cellpadding="0" cellspacing="1" bgcolor="#95B8E7" class="tableBorder">
  <tr> 
    <td height="25" align="center" bgcolor="#95B8E7" onclick="showsubmenu(4)"><font color="#FFFFFF"><strong>服务器连接速度</strong></font> 
...
<a href="#top" title="返回顶部"><font face='Webdings' color=#FFFFFF>5</font></a> <span id=txt4 name=txt4><a href='#' title='关闭此项'><font face='Wingdings' color=#FFFFFF>x</font></a></span> 
  ...
  <tr> 
    <td bgcolor="#F8F9FC" style="display" id='submenu4'> <table width="100%" border="0" cellspacing=1 cellpadding=3 bgcolor="#95B8E7">
        <tr bgcolor="#FFFFFF"> 
          <td width="80">接入设备</td>
